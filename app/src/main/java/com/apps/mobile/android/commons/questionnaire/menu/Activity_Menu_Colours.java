package com.apps.mobile.android.commons.questionnaire.menu;
...
public abstract class Activity_Menu_Colours extends Activity_Base_Questionnaire {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int currOrderNumber = ConfigurationUtils_Colours.getOrderNumber(getUserSettings().uiColoursID);
	...
	public void changeColours(int uiColoursCfgID) {
		...
		getUserSettings().uiColoursID = uiColoursCfgID;
